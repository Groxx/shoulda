...
Using shared_context lets you re-use those costly database-object-graphs!
...
Check it out, all those pass!  Now refactor those massive hundred-assertion
should blocks that you've done because making the same objects a hundred
times slows your tests to a crawl!  (we know you have them, everybody does!)
